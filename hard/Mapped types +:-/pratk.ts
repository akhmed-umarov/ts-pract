...
type GoogleTestPlusPar = MyPlus<GoogleTest , 'par'>
    ...
    //     } else {
    //         hashMap[nums[ind]] = [...hashMap[nums[ind]], ind];
    //     }
    // }
        // if (hashMap[needNumber]) {
        //     if (nums[ind] === needNumber && hashMap[needNumber].length > 1) { 
        //         result = [ind, hashMap[needNumber].filter(el=> el !== ind)[0]]
        //     } else if (nums[ind] !== needNumber) { 
        //         result = [ind, hashMap[needNumber][0]]
        //     }
        // }
